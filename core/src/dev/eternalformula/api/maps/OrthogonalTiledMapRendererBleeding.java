...
/**
 * Not my code. Graciously provided by a wonderful LibGDX discord member.
 * @since Alpha 0.0.2
 */
	...
	public void renderObject(MapObject object) {
		...
		if (object instanceof TextureMapObject) {
			...
			batch.draw(texObj.getTextureRegion(),
					(texObj.getX() / EFGFX.PPM), 
					(texObj.getY() / EFGFX.PPM), 
					texObj.getOriginX(), texObj.getOriginY(), 
					texObj.getTextureRegion().getRegionWidth() / EFGFX.PPM, 
					texObj.getTextureRegion().getRegionHeight() / EFGFX.PPM, 
